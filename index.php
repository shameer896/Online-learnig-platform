            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    ...
                    <div class="carousel-caption">
                        <h2 class="animated bounceInRight" style="animation-delay: 1s">We Are <span>learners</span></h2>
                        <h3 class="animated bounceInLeft" style="animation-delay: 2s">online platform to learn</h3>
                ...
                <div class="item">
                    ...
                    <div class="carousel-caption">
                        <h2 class="animated slideInDown" style="animation-delay: 1s">We Are <span>learners</span></h2>
                        <h3 class="animated fadeInUp" style="animation-delay: 2s">Online learning platform</h3>
                ...
                <div class="item">
                    ...
                    <div class="carousel-caption">
                        <h2 class="animated zoomIn" style="animation-delay: 1s">We Are <span>Learners</span></h2>
                        <h3 class="animated fadeInLeft" style="animation-delay: 2s">Online learning platforms</h3>
                        <p class="animated zoomIn" style="animation-delay: 3s"><a href="#">Contact us</a></p>
                    </div>
                </div>
